...
class _ScanQRScreenState extends State<ScanQRScreen> {
  ...
  Future<void> _handleScan(BarcodeCapture barcodeCapture) async {
    // Get the first barcode's raw value, which should be the session ID
    final sessionId = barcodeCapture.barcodes.first.rawValue;

    // Check if the scanned value is a valid session ID
